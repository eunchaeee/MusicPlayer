...
class ViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    func addPlayPauseButton() {
        ...
        centerY = NSLayoutConstraint(item: button, attribute: NSLayoutConstraint.Attribute.centerY,
                                     relatedBy: NSLayoutConstraint.Relation.equal, toItem: self.view, attribute: NSLayoutConstraint.Attribute.centerY,
...
//        self.addViewWithCode()
    ...
    func audioPlayerDecodeErrorDidOccur(_ player: AVAudioPlayer, error: Error?) {
        ...
        let okAction: UIAlertAction = UIAlertAction(title: "확인", style: UIAlertAction.Style.default) { (action: UIAlertAction
        ) -> Void in
